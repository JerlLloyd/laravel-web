...
<body>
    <header class="px-4 py-2 shadow bg-green-900">
        <div class="flex justify-between">
            ...
            <div class="flex items-center">
                ...
                <button data-dropdown class="flex items-center px-3 py-2 focus:outline-none hover:bg-gray-200 hover:rounded-md" type="button" x-data="{ open: false }" @click="open = true" :class="{ 'bg-gray-200 rounded-md': open }">
                    ...
                    <span class="ml-4 text-sm text-white hidden md:inline-block">Your Profile</span>
                    ...
                    <div data-dropdown-items class="text-sm text-left  absolute top-0 right-0 mt-16 mr-4 bg-white-200  rounded border border-gray-400 shadow" x-show="open" @click.away="open = false">
                        <ul>
                            <li class="px-4 py-3 border-b hover:bg-white-200"><a href="{{ route ('admin/profile') }}">My Profile</a></li>
                            <li class="px-4 py-3 border-b hover:bg-white-200"><a href="#">Settings</a></li>
                            <li class="px-4 py-3 hover:bg-white-200"><a href="{{ route('logout') }}">Log out</a></li>
                        </ul>
                    </div>
                </button>
    ...
    <div class="flex flex-row">
        <div class="flex flex-col w-64 h-screen overflow-y-auto bg-green-900 border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
            <div class="sidebar text-center bg-green-900">
                ...
                <div class="p-2.5 flex items-center rounded-md px-4 duration-300 cursor-pointer bg-green-900 text-white">
