...
<body>
    <header class="px-4 py-2 shadow bg-blue-400">
    ...
    <div class="flex flex-row">
        <div class="flex flex-col w-64 h-screen overflow-y-auto bg-blue-400 border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
            <div class="sidebar text-center bg-blue-400">
